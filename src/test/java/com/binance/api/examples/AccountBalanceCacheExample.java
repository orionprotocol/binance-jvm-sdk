...
import static com.binance.api.client.domain.event.EventType.ACCOUNT_POSITION_UPDATE;
...
public class AccountBalanceCacheExample {
  ...
  private String initializeAssetBalanceCacheAndStreamSession() {
    ApiRestClient client = clientFactory.newRestClient();
  ...
  public static void main(String[] args) {
    new AccountBalanceCacheExample(Constants.SPOT_API_KEY, Constants.SPOT_API_SECRET);
  }
}
