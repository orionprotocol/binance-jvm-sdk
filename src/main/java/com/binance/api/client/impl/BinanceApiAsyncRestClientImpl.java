...
public class BinanceApiAsyncRestClientImpl implements BinanceApiAsyncRestClient {
    ...
    public BinanceApiAsyncRestClientImpl(String apiKey, String secret) {
        binanceApiService = BinanceApiServiceGenerator.createSpotService(apiKey, secret);
    }
    ...
    public void getAllPrices(BinanceApiCallback<List<TickerPrice>> callback) {
        binanceApiService.getLatestPricesV3().enqueue(new BinanceApiCallbackAdapter<>(callback));
    }
    ...
    @Override
    public void withdraw(String asset, String address, String nework, String amount, String name, String addressTag, BinanceApiCallback<WithdrawResult> callback) {
        binanceApiService.withdraw(asset, address, nework, amount, name, addressTag, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis())
                .enqueue(new BinanceApiCallbackAdapter<>(callback));
    }
    ...
    @Override
    public void getDefaultDepositAddress(String asset, BinanceApiCallback<DepositAddress> callback) {
        binanceApiService.getDefaultDepositAddress(asset, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis())
                .enqueue(new BinanceApiCallbackAdapter<>(callback));
    }

    @Override
    public void getDepositAddress(DepositAddressRequest request, BinanceApiCallback<DepositAddress> callback) {
        binanceApiService.getDepositAddress(request.getCoin(), request.getNetwork(), BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis())
                .enqueue(new BinanceApiCallbackAdapter<>(callback));
    }
