...
import com.binance.api.client.domain.general.CoinInfo;
 ...
 */
public interface ApiRestClient extends BinWebSocketManager {
  ...
  /**
   * Get best price/qty on the order book for symbol.
   */
  BookTicker getBookTicker(String symbol);

  /**
   * Get best price/qty on the order book for specified symbols.
   */
  List<BookTicker> getBookTicker(List<String> symbols);
   ...
   */
  WithdrawResult withdraw(String asset, String address, String network, String amount, String name, String addressTag);
  ...
  /**
   * Fetch default deposit address.
   *
   * @return deposit address for a given asset.
   */
  DepositAddress getDefaultDepositAddress(String request);
   ...
   * @return deposit address for a given asset.
   */
  DepositAddress getDepositAddress(DepositAddressRequest request);

  /**
   * Transfer asset from Spot to Futures USD-M
   *
   * @return transactionId
   */

  Transaction transfer(String asset, String amount, SpotTransferType type);

    /**
     * Universel asset transfer
     *
     * @return transactionId
     */
    Transaction universalTransfer(UniversalTransferRequest request);

    /**
     * Convert some assets ('dust') to BNB
     */
    DustTransferResponse convertToBNB(List<String> assets);

  SwapRecord convertFunds(String quoteAsset, String baseAsset, String quoteQty);
