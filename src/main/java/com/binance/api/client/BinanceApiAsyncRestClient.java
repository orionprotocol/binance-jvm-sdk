...
public interface BinanceApiAsyncRestClient {
   ...
   */
  void withdraw(String asset, String address, String network, String amount, String name, String addressTag, BinanceApiCallback<WithdrawResult> callback);
   ...
   */
   void getDefaultDepositAddress(String asset, BinanceApiCallback<DepositAddress> callback);
   ...
   * @param callback the callback that handles the response and returns the deposit address
   */
  void getDepositAddress(DepositAddressRequest request, BinanceApiCallback<DepositAddress> callback);
